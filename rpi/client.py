...
LISTEN_PORT = 3244              # Port this Pi listens on for incoming data
...
control = {
    ...
    "turn":  0.00,   # -1.0 (full left)    to 1.0 (full right)
}
    ...
    while not stop_event.is_set():
        ...
        try:
            ...
            if payload.get("type") != "telemetry":
                print(f"[receiver] Ignored non-telemetry packet (type={payload.get('type')!r}) from {addr}")
                continue
