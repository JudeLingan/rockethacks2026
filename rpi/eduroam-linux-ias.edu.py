...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Institute for Advanced Study"
Config.profilename = "Institute for Advanced Study"
Config.url = "https://www.ias.edu/campus-resources/ias-computing"
Config.email = "network@ias.edu"
Config.title = "eduroam CAT"
Config.server_match = "radius.net.ias.edu"
...
Config.user_realm = "ias.edu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.net.ias.edu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ias.edu"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = """Compliance with this policy
...

-----END CERTIFICATE-----
"""
